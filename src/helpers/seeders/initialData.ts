...
export class InitialDataSeederService {
    ...
    private async seedMetadata() {
        console.log("🚀 Seeding Metadata table with INITIAL DATA...");
        ...
        if (!existing) {
            ...
            console.log(
                "🟢 Seeding Metadata table with INITIAL DATA is done successfully."
            );
        } else {
            console.log(
                "🟨 Seeding Metadata table with INITIAL DATA was done earlier."
            );
        }
    }

    private async seedRole(role) {
        console.log(`🚀 Seeding Role table with INITIAL DATA of ${role}...`);
        ...
        if (!existingRole) {
            ...
            console.log(
                `🟢 Seeding Role table with INITIAL DATA of ${role} is done successfully.`
            );
        } else {
            console.log(
                `🟨 Seeding Role table with INITIAL DATA of ${role} was done earlier.`
            );
        }
    }

    private async seedBasicRoles() {
        console.log("🚀 Seeding Role table with INITIAL DATA...");
    ...
    private async seedInitialPermissions() {
        console.log("🚀 Seeding Permission table with INITIAL DATA...");
        ...
        for (const permission of permissions) {
            ...
            if (!existing) {
                console.log(
                    `🚀 Seeding Permission table with INITIAL DATA of ${description}...`
                );
                ...
                console.log(
                    `🟢 Seeding Permission table with INITIAL DATA of ${description} is done successfully.`
                );
            } else {
                console.log(
                    `🟨 Seeding Permission table with INITIAL DATA of ${description} was done earlier.`
                );
            }
        }
    }
    ...
    private async seedUser({
        ...
        if (!existing) {
            ...
            console.log(
                `🟢 Seeding User table with INITIAL DATA of ${email} is done successfully.`
            );
        } else {
            console.log(
                `🟨 Seeding User table with INITIAL DATA of ${email} was done earlier.`
            );
        }
    }

    private async seedUsers() {
        console.log("🚀 Seeding User table with INITIAL DATA...");
    ...
    async seed() {
        console.log("🚀🚀 Seeding tables with INITIAL DATA...");
        ...
        console.log("✅ All tables seeded with INITIAL DATA successfully.");
    }
}
